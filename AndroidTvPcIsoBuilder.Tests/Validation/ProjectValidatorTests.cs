...
public class ProjectValidatorTests
{
    ...
    private AndroidTvProject CreateValidProject()
    {
        const string sourceIsoPath = "C:\\Sources\\android-tv.iso";
        ...
        return new()
        {
            ...
            SourceIso = new SourceIsoSelection { LocalPath = sourceIsoPath }
        };
    }
    ...
    [TestMethod]
    public void Validate_SourceIsoManquante_RetourneUnEchec()
    {
        var project = CreateValidProject();
        project.SourceIso.LocalPath = null;
    ...
    [TestMethod]
    public void Validate_SourceIsoIntrouvable_RetourneUnEchec()
    {
        var project = CreateValidProject();
        project.SourceIso.LocalPath = "C:\\Sources\\introuvable.iso";
